var tipotarjeta = function () {
    var table = null;
    var obj = null;

    var configurarDataTable = function () {
        table = $("table#tipotarjeta_table").DataTable(
            {
                responsive:true,
                ajax: Routing.generate('tipotarjeta_index'),
                "language": {
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#tipotarjeta_new', function (evento)
        {
            evento.preventDefault();
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#tipotarjeta_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
    ...
    var eliminar = function () {
        $('div#basicmodal').on('click', 'a.eliminar_tipotarjeta', function (evento)
        {
           ...
           bootbox.confirm({
                ...
                message: "<div class='text-justify'><p class='confirm_message'>¿Está seguro que desea eliminar este tipo de tarjeta?</p><p class='confirm_detail'>Esta acción no se podrá deshacer</p></div>",
                buttons: {
                    confirm: {
