var tipoactividad = function () {
    ...
    var configurarDataTable = function () {
        table = $("table#tipoactividad_table").DataTable(
            {
                responsive:true,
                ajax: Routing.generate('tipoactividad_index'),
                "language": {
    ...
    var newAction = function () {
        $('div#basicmodal').on('submit', 'form#tipoactividad_new', function (evento)
        {
            evento.preventDefault();
    ...
    var edicionAction = function () {
        $('div#basicmodal').on('submit', 'form#tipoactividad_edit', function (evento)
        {
            evento.preventDefault();
            var padre = $(this).parent();
            var l = Ladda.create(document.querySelector( '.ladda-button' ) );
    ...
    var eliminar = function () {
        $('table#tipoactividad_table').on('click', 'a.eliminar_tipoactividad', function (evento)
        {
           ...
           bootbox.confirm({
                ...
                message: "<div class='text-justify'><p class='confirm_message'>¿Está seguro que desea eliminar este tipo de actividad?</p><p class='confirm_detail'>Esta acción no se podrá deshacer</p></div>",
                buttons: {
                    confirm: {
