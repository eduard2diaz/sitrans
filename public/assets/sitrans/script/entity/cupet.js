var cupet = function () {
                ...
                columnDefs:[
                    ...
                    {targets:-1,title:" ",orderable:!1,render:function(a,e,t,n){
                        return' <ul class="m-nav m-nav--inline m--pull-right">'+
                            '<li class="m-nav__item"><a class="btn btn-metal m-btn m-btn--icon btn-sm text-uppercase cupet_show" data-href="'+Routing.generate('cupet_show',{id:t.id})+'"><i class="flaticon-eye"></i> Visualizar</a></li>' +
                            '<li class="m-nav__item"><a class="btn btn-info m-btn m-btn--icon btn-sm text-uppercase edicion" data-href="'+Routing.generate('cupet_edit',{id:t.id})+'"><i class="flaticon-edit-1"></i> Editar</a></li></ul>';
                    }
                }]
            });
    }
    ...
    var eliminar = function () {
        $('div#basicmodal').on('click', 'a.eliminar_cupet', function (evento)
        {
            evento.preventDefault();
            var link = $(this).attr('data-href');
            $('div#basicmodal').modal('hide');
